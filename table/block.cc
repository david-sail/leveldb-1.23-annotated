...
class Block::Iter : public Iterator {
 private:
  ...
  //获取restart数组中第index个对应的data offset
 ...
 public:
  ...
  //最后一个data entry;注意不是最后一个data block
  ...
  bool ParseNextKey() {
    ...
    if (p == nullptr || key_.size() < shared) {
      ...
      while (restart_index_ + 1 < num_restarts_ &&
        ...
        //如果current_已经越过了restart array restart_index_个,那么就增加一个.使current_,restart_index_保持一致
        ++restart_index_;
      }
      return true;
    }
